...
class TransactionCategoryService:
    ...
    This service handles CRUD operations for transaction categories using Google
    Cloud Firestore.
    """
    ...
    def create_transaction_category(
        self, category_data: TransactionCategoryCreate
    ) -> TransactionCategory:
        """
        ...
        if existing_category is not None:
            raise ValueError(
                f"Transaction category with name '{category_data.name}' already exists"
            )
        ...
        category_dict.update({"date_created": now, "date_last_updated": now})
    ...
    def update_transaction_category(
        self, category_id: str, category_data: TransactionCategoryUpdate
        ...
        try:
            ...
            if "name" in update_dict:
                ...
                if (
                    ...
                    raise ValueError(
                        f"Transaction category with name '{update_dict['name']}' "
                        f"already exists"
                    )
    ...
    def delete_transaction_category(self, category_id: str) -> bool:
        ...
        try:
            ...
            # TODO: Add check for existing transactions when transaction model is
            # implemented
